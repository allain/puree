...
var state = {
  items: [{ label: 'a', url: 'http://a.com' }, { label: 'b', url: 'http://b.com' }, { label: 'c', url: 'http://c.com' }],
  active: 'b',
  time: new Date()
};
...
function render(_ref2) {
  ...
  return h(
    ...
    h(
      'p',
      null,
      'The Menu Built below receives params that don\'t change'
    ),
    h(Menu, { name: 'Static Menu', items: items, active: state.active }),
    h(
      'p',
      null,
      'The Menu Built below receives params that change (time)'
    ),
    h(Menu, { name: 'Dynamic Menu', items: items, active: state.active, time: time })
  );
}

var puree = Puree(render, document.getElementById('app'));

setInterval(function () {
  // New object with time replaced with the current time
  var newState = Object.assign({}, state, { time: new Date() });
...
function h(tag, options) {
  ...
  if (typeof tag !== 'function') return vdom.h(tag, options, children);
...
function Puree(builder, el) {
  ...
  return function (state) {
    ...
    if (el) {
      if (rootNode !== null) return patch(rootNode, diff(lastTree, newTree));
...
},{"./thunk.js":51,"vdom-to-html":18,"virtual-dom":24}],4:[function(require,module,exports){
/*!
...
},{"./vendor/camel-case-regexp":14,"./vendor/non-word-regexp":15,"./vendor/trailing-digit-regexp":16,"lower-case":11}],14:[function(require,module,exports){
...
},{"./property-config":19,"escape-html":5}],18:[function(require,module,exports){
var escape = require('escape-html');
...
},{"./create-attribute":17,"./void-elements":20,"escape-html":5,"param-case":12,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":32,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":34,"virtual-dom/vnode/is-thunk":38,"virtual-dom/vnode/is-vnode":40,"virtual-dom/vnode/is-vtext":41,"virtual-dom/vnode/is-widget":42,"xtend":50}],19:[function(require,module,exports){
/**
 * Attribute types.
 */
...
},{"./vtree/diff.js":48}],23:[function(require,module,exports){
var h = require("./virtual-hyperscript/index.js")

module.exports = h

},{"./virtual-hyperscript/index.js":35}],24:[function(require,module,exports){
...
},{"./create-element.js":21,"./diff.js":22,"./h.js":23,"./patch.js":25,"./vnode/vnode.js":44,"./vnode/vtext.js":46}],25:[function(require,module,exports){
...
},{"../vnode/is-vhook.js":39,"is-object":10}],27:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":37,"../vnode/is-vnode.js":40,"../vnode/is-vtext.js":41,"../vnode/is-widget.js":42,"./apply-properties":26,"global/document":7}],28:[function(require,module,exports){
...
},{"./create-element":27,"./dom-index":28,"./patch-op":29,"global/document":7,"x-is-array":49}],31:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
function render(previous) {
  if (shouldUpdate(this, previous)) return this.fn.apply(null, [Object.assign({ children: this.children }, this.props)]);
